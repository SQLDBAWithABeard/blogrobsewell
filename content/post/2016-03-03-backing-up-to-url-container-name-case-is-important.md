...
---
If you use [SQL Backup to URL](https://msdn.microsoft.com/en-us/library/dn435916.aspx?WT.mc_id=DP-MVP-5002693) to backup your databases to Azure blob storage remember that for the container name case is important
