...
---
When I was at [PowerShell Conference EU](http://www.psconf.eu/) in Hannover last month (The videos are available now – [click here](https://www.youtube.com/c/powershellconferenceeu) and the [slides and code here](https://github.com/psconfeu/2016?WT.mc_id=DP-MVP-5002693)) I found out about [Irwin Strachans Active Directory Operations Test](https://pshirwin.wordpress.com/2016/04/08/active-directory-operations-test/) which got me thinking.
...
You can find the tests on [GitHub here](https://github.com/SQLDBAWithABeard/Functions/blob/master/Test-SQLDefaults.ps1?WT.mc_id=DP-MVP-5002693) and I will continue to add to the defaults that I check.  
