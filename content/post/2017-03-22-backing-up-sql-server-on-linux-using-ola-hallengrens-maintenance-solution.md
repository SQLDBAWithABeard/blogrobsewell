...
---
<P>With <A href="https://blogs.technet.microsoft.com/dataplatforminsider/2017/03/17/sql-server-next-version-ctp-1-4-now-available/?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>the release of SQL Server vNext CTP 1.4 </A>SQL Agent was released for use on Linux. To install it on Ubuntu you need to upgrade your SQL Server to CTP 1.4. On Ubuntu you do this with</P><PRE class="lang:sh decode:true">sudo apt-get update
...
<P>for different flavours of Linux <A href="https://docs.microsoft.com/en-us/sql/linux/sql-server-linux-setup-sql-agent?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>follow the steps here</A></P>
...
SET @CleanupTime =undefined-- Time in hours, after which backup files are deleted. If no time is specified, then no backup files are deleted. 
...
<DIV></DIV>
<P>Now lets run the jobs and check the history using <A href="https://docs.microsoft.com/en-us/powershell/sqlserver/sqlserver-module/vlatest/get-sqlagentjobhistory?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>Get-SqlAgentJobHistory</A></P>
