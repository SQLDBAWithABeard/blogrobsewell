...
---
<P>I have written about <A href="https://dbatools.io/functions/test-dbalastbackup/" target=_blank>Test-DbaLastBackup</A> in posts <A href="/blog/testing-your-sql-server-backups-the-easy-way-with-powershell-dbatools/" target=_blank>here</A>, <A href="/blog/taking-dbatools-test-dbalastbackup-a-little-further/">here </A>and<A href="/blog/using-pester-with-dbatools-test-dbalastbackup/" target=_blank> here</A>. They have been Windows only posts.</P>
<P>With <A href="https://blogs.technet.microsoft.com/dataplatforminsider/2017/03/17/sql-server-next-version-ctp-1-4-now-available/?WT.mc_id=DP-MVP-5002693" target=_blank>SQL Server vNext CTP 1.4 </A>now available and providing SQL Agent capability on Linux, I wrote here about using Ola Hallengrens scripts on Linux SQL Servers so can <A href="https://dbatools.io/functions/test-dbalastbackup/" target=_blank><SPAN style="COLOR: #0066cc">Test-DbaLastBackup</SPAN></A>&nbsp;work with Linux?</P>
