...
``` 
I had a little play with [Boe Prox PoshCharts](https://github.com/proxb/PoshCharts/tree/Dev?WT.mc_id=DP-MVP-5002693) (you have to use the dev branch) to see if I could get some nice charts and unfortunately the bar charts did not come out so well but luckily the donut and pie charts did. (I’m a DBA I love donuts!)
 ```
