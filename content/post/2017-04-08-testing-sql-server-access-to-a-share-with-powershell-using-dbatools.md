...
<DIV></DIV>
<P>So how can I check that I have access from my SQL Server? Sure I could get the password of the SQL Service account and run a process as that account, not saying that’s a good idea but it could be done. Of course it couldn’t be done if you are using <A href="https://technet.microsoft.com/en-us/library/dd560633(v=ws.10).aspx?WT.mc_id=DP-MVP-5002693" target=_blank>Managed Service Accounts </A>or <A href="https://technet.microsoft.com/en-us/library/hh831782(v=ws.11).aspx?WT.mc_id=DP-MVP-5002693" target=_blank>Group Managed Service Accounts</A>&nbsp;but there is a way</P>
<DIV></DIV>
...
<DIV></DIV>
<DIV>Navigate to the <A href="https://github.com/sqlcollaborative/dbatools?WT.mc_id=DP-MVP-5002693" target=_blank>GitHub repository</A> and click on issues. I generally search for the command name in the issues to see if someone else has beaten me to it</DIV>
<DIV></DIV>
...
<DIV></DIV>
<DIV>I created <A href="https://github.com/sqlcollaborative/dbatools/issues/1004?WT.mc_id=DP-MVP-5002693" target=_blank>this issue </A>with a potential fix as well, you don’t have to do that, just letting the folks know is good enough</DIV>
<DIV></DIV>
