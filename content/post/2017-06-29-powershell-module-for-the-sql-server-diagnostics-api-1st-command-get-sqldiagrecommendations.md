...
---
<P>I saw this blog post about the <A href="https://blogs.msdn.microsoft.com/sql_server_team/sql-server-diagnostics-preview/?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>SQL Server Diagnostics add-on to SSMS and API</A> and thought I would write some PowerShell to work with it as all of the examples use other languages.</P>
...
<P>I have written a <A href="https://github.com/SQLDBAWithABeard/SQLDiagAPI?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>module</A> to work with this API. It is not complete. It only has one command as of now but I can see lots of possibilities for improvement and further commands to interact with the API fully and enable SQL Server professionals to use PowerShell for this.</P>
...
<P>If you have any ideas please join in on <A href="https://github.com/SQLDBAWithABeard/SQLDiagAPI?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>GitHub</A></P>
<H2>JSON</H2>
...
<H2>Github</H2>
<P>You can <A href="https://github.com/SQLDBAWithABeard/SQLDiagAPI?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>find the module on GitHub.&nbsp;</A>There are <A href="https://github.com/SQLDBAWithABeard/SQLDiagAPI/blob/master/install.md?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>instructions </A>and a <A href="https://github.com/SQLDBAWithABeard/SQLDiagAPI/blob/master/install.ps1?WT.mc_id=DP-MVP-5002693" rel=noopener target=_blank>script </A>to install it easily.</P>
