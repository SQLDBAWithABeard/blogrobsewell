...
tags:
  ...
  - SQLBits
---
In my last post I showed you [how to write your first Pester test](/blog/write-your-first-pester-test-today/) to validate something. Here’s a recap
...
The first way is to use the Test Case parameter of the It command (the test) which I have written about when [using TDD for Pester here](/blog/writing-dynamic-and-random-tests-cases-for-pester/)
...
I like to use the ForEach method as it is slightly quicker than other methods. It will only work with PowerShell version`Find-DbaCommand connection`and above. Below that version you need to pipe the collection to For-EachObject.
