...
Anyway, I was writing some Pester tests for a module that I was writing when I needed some sample data. I have [written before about using Json for this purpose](/blog/writing-dynamic-and-random-tests-cases-for-pester/) This function required some data from a database so I wrote the query to get the data and used [dbatools](https://dbatools.io) to run the query against the database using [Get-DbaDatabase](https://dbatools.io/functions/Get-DbaDatabase)
