...
If you do not have a GitHub account go to [https://github.com](https://github.com?WT.mc_id=DP-MVP-5002693) and create a new account
...
Next is a very important step - Please do not skip this. You should set upundefinedfactor authentication. Yes even if "It's just for me there is nothing special here"
...
[https://code.visualstudio.com/](https://code.visualstudio.com/?WT.mc_id=DP-MVP-5002693) From the welcome window choose open folder
