...
---
I enjoy maintaining open source GitHub repositories such as [dbachecks](https://github.com/sqlcollaborative/dbachecks?WT.mc_id=DP-MVP-5002693) and [ADSNotebook](https://github.com/sqlcollaborative/ADSNotebook?WT.mc_id=DP-MVP-5002693). I absolutely love it when people add more functionality to them.
...
Let’s take dbachecks as our example. Start by going to the project in GiHub. In this case the URL is [https://github.com/sqlcollaborative/dbachecks](https://github.com/sqlcollaborative/dbachecks?WT.mc_id=DP-MVP-5002693) You will see a Fork button at the top right of the page
...
The page will open at [https://github.com/YOURGITHUBUSERNAME/NameOfRepository](https://github.com/SQLDBAWithABeard/dbachecks?WT.mc_id=DP-MVP-5002693) in this case [https://github.com/SQLDBAWithABeard/dbachecks](https://github.com/SQLDBAWithABeard/dbachecks?WT.mc_id=DP-MVP-5002693) You will be able to see that it is a fork of the original repository at the top of the page
...
In your browser, at your _remote_ repository that you just created ([https://github.com/YOURGITHUBUSERNAME/NameOfRepository](https://github.com/SQLDBAWithABeard/dbachecks?WT.mc_id=DP-MVP-5002693) if you have closed the page) click on  `Clone or Download`  and then the icon to the right to copy the url

![](https://blog.robsewell.com/assets/uploads/2019/11/image-46.png?fit=630%2C316&ssl=1)

You can clone your repository in [VS Code](https://code.visualstudio.com/?WT.mc_id=DP-MVP-5002693) or [Azure Data Studio](https://aka.ms/azuredatastudio) by clicking F1 or CTRL + SHIFT + P in Windows or Linux and ⇧⌘P or F1 on a Mac
...
You can find the Pull Request that I created here [https://github.com/sqlcollaborative/dbachecks/pull/720](https://github.com/sqlcollaborative/dbachecks/pull/720?WT.mc_id=DP-MVP-5002693) and see how the rest of this blog post was created.
...
*   **[PowerShell](https://github.com/PowerShell/PowerShell?WT.mc_id=DP-MVP-5002693)** by Microsoft
*   **[tigertoolbox](https://github.com/microsoft/tigertoolbox?WT.mc_id=DP-MVP-5002693)** by Microsoft Tiger Team
*   [dbatools](https://github.com/sqlcollaborative/dbatools?WT.mc_id=DP-MVP-5002693)
*   [dbachecks](https://github.com/sqlcollaborative/dbachecks?WT.mc_id=DP-MVP-5002693)
*   [ADSNotebook](https://github.com/sqlcollaborative/ADSNotebook?WT.mc_id=DP-MVP-5002693)
*   [PSDatabaseClone](https://github.com/sqlcollaborative/PSDatabaseClone?WT.mc_id=DP-MVP-5002693)
*   **[OpenQueryStore](https://github.com/OpenQueryStore/OpenQueryStore?WT.mc_id=DP-MVP-5002693)** by William Durkin and Enrico van de Laar
*   **[sqlwatch](https://github.com/marcingminski/sqlwatch?WT.mc_id=DP-MVP-5002693)** by Marcin Gminski
*   [SQLCop](https://github.com/red-gate/SQLCop?WT.mc_id=DP-MVP-5002693) by Redgate
*   **[sp_whoisactive](https://github.com/amachanic/sp_whoisactive?WT.mc_id=DP-MVP-5002693)** by Adam Machanic
*   **[sql-server-maintenance-solution](https://github.com/olahallengren/sql-server-maintenance-solution?WT.mc_id=DP-MVP-5002693)** by Ola Hallengren
*   **[SQL-Server-First-Responder-Kit](https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit?WT.mc_id=DP-MVP-5002693)** by Brent Ozar Unlimited
*   **[Pester](https://github.com/pester/Pester?WT.mc_id=DP-MVP-5002693)**
*   **[ReportingServicesTools](https://github.com/microsoft/ReportingServicesTools?WT.mc_id=DP-MVP-5002693)**
