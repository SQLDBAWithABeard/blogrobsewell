...
Let's back up a bit and set the environment up. I am using Docker on Windows Subsystem for Linux 2 (WSL2) I installed it [using this guide](https://code.visualstudio.com/blogs/2020/03/02/docker-in-wsl2?WT.mc_id=DP-MVP-5002693). I believe this will work using native Docker, you would just need to replace the  `$PWD`  in the example below with a dot  `.` 
