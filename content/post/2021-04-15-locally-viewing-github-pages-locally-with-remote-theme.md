...
[![nogemsources](/assets/uploads/2021/nogemsources.png)](/assets/uploads/2021/nogemsources.png)
...
First we need to know which version of Jekyll GitHub Pages is using. You can find all of that information here [https://pages.github.com/versions/](https://pages.github.com/versions/?WT.mc_id=DP-MVP-5002693)  

[![ghpagesversions](/assets/uploads/2021/githubpagesversions.jpg)](/assets/uploads/2021/githubpagesversions.jpg)  
...
[![noimage](/assets/uploads/2021/noimage.jpg)](/assets/uploads/2021/noimage.jpg)  
...
Let's back up a bit and set the environment up. I am using Docker on Windows Subsystem for Linux`docker pull jekyll/jekyll:3.8.6`(WSL2) I installed it [using this guide](https://code.visualstudio.com/blogs/2020/03/02/docker-in-wsl2?WT.mc_id=DP-MVP-5002693). I believe this will work using native Docker, you would just need to replace the   `$PWD`   in the example below with a dot   `.`  
...
The   `--rm`   means that the container will be removed when it is stopped,   `--volume="$PWD:/srv/jekyll"`   maps the current directory locally to the   `/srv/jekyll`   directory in the container so I need to change the directory to my local repository for my blog.   `-p 4001:4000`   says map portundefinedon my machine to portundefinedon the container. This means that I can view the blog locally at https://localhost:4001.   `jekyll serve`   will build the site and run it for me.
...
[![jekyllerror](/assets/uploads/2021/jekyllerror.jpg)](/assets/uploads/2021/jekyllerror.jpg)  
...
[![regenerate](/assets/uploads/2021/regenerate.jpg)](/assets/uploads/2021/regenerate.jpg)  
...
[![futureposts](/assets/uploads/2021/futureposts.jpg)](/assets/uploads/2021/futureposts.jpg)  
...
[![downloadingthings](/assets/uploads/2021/downloadingthings.jpg)](/assets/uploads/2021/downloadingthings.jpg)  
...
[![dockerps](/assets/uploads/2021/dockerps.jpg)](/assets/uploads/2021/dockerps.jpg)  

Use the first`$PWD`characters of the container. In my example it is   `760`  . If you have more than one, look for the one with the   `jekyll/jekyll:3.8.6`   as the image.  
...
[![muchquicker](/assets/uploads/2021/muchquicker.jpg)](/assets/uploads/2021/muchquicker.jpg)  
