---
title: "The Label on My Drawer Has Changed"
date: "2026-02-27"
categories:
  - Blog
  - Community
...
I am genuinely, ridiculously excited to announce that I've joined [Zure UK](https://zure.com) as Chief Data Officer. I announced it on [LinkedIn in my own special way with a beard unveiling](https://www.linkedin.com/posts/robmsewell_zure-roaratchallenge-buildingateam-activity-7433065502761201664-WCrK) :-)

Go on, I'll say it again. *Chief Data Officer.* I keep saying it to Traci [S](https://bsky.app/profile/tracisewell.com) [L](https://www.linkedin.com/in/traci-sewell-5450452bb) and she keeps smiling politely while I grin like an idiot. She's very patient.

## So, What Is Zure?

If you haven't come across [Zure](https://zure.com) before, let me introduce you. They are a Microsoft Azure-focused digital services company — exclusively Azure, no hedging, no "well we also do a bit of AWS" — with stupendously clever folk based in Finland, Belgium, Denmark, the Netherlands, and now growing here in the UK. They have several Microsoft RDs and MVPs on staff (I like these people already), an incredible community culture, and a philosophy I find genuinely refreshing: "Roar at Challenge."

The [about page](https://zure.com/about) talks about facing challenges without fear, learning from failures openly, and shared responsibility with individual impact. If you've read this blog for any length of time, you'll know that resonates deeply with me. I've been banging on about sharing failures as a community for years. These are my kind of people.
...
If that sounds like something you'd want to be part of — get in touch. You can book a no-obligation chat with me [through this link](https://robsewell.com/chat-about-zure) and we can talk about what we're building, where we're going, and whether you might want to be part of it.

Or you can just find me on [LinkedIn](https://www.linkedin.com/in/robsewell) or [Bluesky](https://bsky.app/profile/robsewell.com) and send me a message there.


 Here is a link to the [Zure careers page](https://zure.com/careers) where you can see the roles we're hiring for.
...
If you're looking at your data platform and wondering how to make it actually work for your organisation, how to integrate AI and analytics to your processes — or if you're thinking about Microsoft Fabric and want to understand what it can mean for you and your company — I'd genuinely love to have that conversation. You can find me on [LinkedIn](https://www.linkedin.com/in/robsewell) or [Bluesky](https://bsky.app/profile/robsewell.com), or just turn up at a conference and tap me on the shoulder.
...
*If you want to know more about Zure, have a look at [zure.com](https://zure.com) — and particularly the [community](https://zure.com/community) and [careers](https://zure.com/careers) pages if you want to see the kind of company they are. I think you'll like what you find.*
